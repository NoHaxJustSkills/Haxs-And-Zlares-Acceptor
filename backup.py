...
print('Instagram follow request accepter, get in touch with me at @phrased @ZLARE on tele if you have any questions\n')
print('<<<THIS IS A ' + Fore.GREEN + 'PAID' + Fore.RESET + ' ACCEPTER,ADAPTED FROM CLAPPEDS,SO ITS FASTER>>>')
